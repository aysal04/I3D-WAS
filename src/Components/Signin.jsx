...
function Signin() {
  ...
  const signInButton= {
    ...
    <div className='d-flex justify-content-center'>
        ...
        <MDBInput wrapperClass='mb-5' style={inputStyle} placeholder='Password' id='form2' required type='password' />
    </div>

        <div className="d-flex justify-content-between mx-3 mb-4">
          <MDBCheckbox name='flexCheck' value='' id='flexCheckDefault' required label='Remember me' />
          <a href="!#">Forgot password?</a>
        </div>

        <MDBBtn type='submit' className="mb-4" style={signInButton}>Sign in</MDBBtn>
        </form>
