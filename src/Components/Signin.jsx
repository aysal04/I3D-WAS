...
function Signin() {
  ...
  const signInButton= {
    ...
    <MDBInput wrapperClass='mb-4' style={inputStyle} placeholder='Email address' id='form1' type='email' />
    </div>
    <div className='d-flex justify-content-center'>
        <VpnKeyOutlinedIcon style={{marginRight:'10px', marginTop:'8px'}}/>
        <MDBInput wrapperClass='mb-5' style={inputStyle} placeholder='Password' id='form2' type='password' />
    </div>
        ...
        <MDBBtn className="mb-4" style={signInButton}>Sign in</MDBBtn>
